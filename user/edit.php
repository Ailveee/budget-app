...
// ✅ Access control: only the owner (user_id) or admin can edit
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Admin-only: check if accepting exceeds budget
...
<main>
    ...
    <p><a href="<?= $userRole === 'admin' ? '../admin/demands/index.php' : '../user/index.php' ?>">Back to Demands List</a></p>
</main>
